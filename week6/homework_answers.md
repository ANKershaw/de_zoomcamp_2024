...
additional needed (due to already running containers):
...
for i in range(10):
    ...
    producer.send(topic_name, value=message)
    tend = time.time()
    print(f"Sent: {message} in {(tend - tsend):.10f} seconds")
    time.sleep(0.05)

tflush = time.time()
producer.flush()
tflushend = time.time()
print(f'flush took {(tflushend - tflush):.10f} seconds overall')

t1 = time.time()
print(f'took {(t1 - t0):.2f} seconds overall')
```
output:
```commandline
Sent: {'number': 0} in 0.0005338192 seconds
Sent: {'number': 1} in 0.0002348423 seconds
Sent: {'number': 2} in 0.0002088547 seconds
Sent: {'number': 3} in 0.0003030300 seconds
Sent: {'number': 4} in 0.0002999306 seconds
Sent: {'number': 5} in 0.0002481937 seconds
Sent: {'number': 6} in 0.0004680157 seconds
Sent: {'number': 7} in 0.0004253387 seconds
Sent: {'number': 8} in 0.0002150536 seconds
Sent: {'number': 9} in 0.0003089905 seconds
flush took 0.0001189709 seconds overall
took 0.54 seconds overall
```
...
```commandline
redpanda@20d58e633e13:/$ rpk topic create green-trips
TOPIC        STATUS
green-trips  OK
```
